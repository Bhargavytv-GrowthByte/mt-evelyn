...
<div id="page-menu">
  ...
  <div id="tab-traditional" class="menu-section active">
    ...
    <div class="menu-grid">
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Pepperoni pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Pepperoni</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, pepperoni</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="Margherita pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Margherita <span class="item-tag">Veg</span></div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, oregano, basil</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Garlic pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Garlic <span class="item-tag">Veg</span></div><div class="menu-card-desc">Garlic base, mozzarella cheese, oregano</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&q=70&auto=format&fit=crop" alt="Vegetarian pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Vegetarian <span class="item-tag">Veg</span></div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, mushrooms, capsicum, onions, olives, pineapple</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Aussie pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Aussie</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, bacon, egg</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="Hawaiian pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Hawaiian</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, ham, pineapple</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Capricciosa pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Capricciosa</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, ham, mushrooms, olives, artichokes</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&q=70&auto=format&fit=crop" alt="Mexicana pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Mexicana</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, pepperoni, capsicum, onions, chilli</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Marinara pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Marinara</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, prawns, garlic, oregano</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="BBQ Chicken pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">BBQ Chicken</div><div class="menu-card-desc">BBQ sauce, mozzarella cheese, chicken, onions, capsicum</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Napolitana pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Napolitana</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, anchovies, olives, oregano</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&q=70&auto=format&fit=crop" alt="Meat Lovers pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Meat Lovers</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, ham, pepperoni, bacon, salami</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Super Special pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Super Special</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, ham, pepperoni, mushrooms, capsicum, onions, olives</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="Tropical Chicken pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Tropical Chicken</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, chicken, pineapple, capsicum</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Satay Chicken pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Satay Chicken</div><div class="menu-card-desc">Satay sauce, mozzarella cheese, chicken, onions, capsicum, peanuts</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&q=70&auto=format&fit=crop" alt="Americana pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Americana</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, ham, bacon</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Sweet Chilli Chicken pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Sweet Chilli Chicken</div><div class="menu-card-desc">Sweet chilli sauce, mozzarella cheese, chicken, capsicum, onions</div><div class="menu-card-price">$11.99 / $16.49 / $20.99</div></div></div>
    </div>
  </div>
  ...
  <div id="tab-gourmet" class="menu-section">
    ...
    <div class="sec-divider"></div>
    <div class="menu-grid">
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="The Todak pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">The Todak</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, chicken, prawns, scallops, garlic</div><div class="menu-card-price">$22.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&q=70&auto=format&fit=crop" alt="Lamb pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Lamb</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, lamb, onions, capsicum, tzatziki drizzle</div><div class="menu-card-price">$22.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Gourmet Vegetarian pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Gourmet Vegetarian <span class="item-tag">Veg</span></div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, semi dried tomatoes, spinach, feta, mushrooms, olives</div><div class="menu-card-price">$22.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="The Burger pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">The Burger</div><div class="menu-card-desc">BBQ sauce, mozzarella cheese, beef, bacon, onions, pickles, mustard drizzle</div><div class="menu-card-price">$22.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Caesar pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Caesar</div><div class="menu-card-desc">Garlic base, mozzarella cheese, chicken, bacon, parmesan, Caesar drizzle, onions</div><div class="menu-card-price">$22.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Tandoori Chicken pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Tandoori Chicken</div><div class="menu-card-desc">Tandoori base, mozzarella cheese, tandoori chicken, onions, capsicum, yogurt drizzle</div><div class="menu-card-price">$22.99</div></div></div>
    </div>
    <div class="note-box" style="max-width:1120px;margin:18px auto 0;"><strong style="color:var(--gold);">Extra Toppings +$2</strong> — Ham, chicken, pepperoni, bacon, pineapple, mushrooms, onions, capsicum, olives, jalapeños, prawns, anchovies and garlic. &nbsp;·&nbsp; <strong style="color:var(--gold);">Half n Half / Any Changes +$3</strong> — choose any two halves or request changes to your pizza.</div>
  </div>
  ...
  <div id="tab-lunch" class="menu-section">
    ...
    <div class="sec-divider"></div>
    <div class="menu-grid">
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="Margherita pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Margherita <span class="item-tag">Veg</span></div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, oregano, basil. Plus a can of drink.</div><div class="menu-card-price">$9.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1513104890138-7c749659a591?w=500&q=70&auto=format&fit=crop" alt="Hawaiian pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Hawaiian</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, ham, pineapple. Plus a can of drink.</div><div class="menu-card-price">$9.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1604382354936-07c5d9983bd3?w=500&q=70&auto=format&fit=crop" alt="Aussie pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Aussie</div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, bacon, egg. Plus a can of drink.</div><div class="menu-card-price">$9.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=500&q=70&auto=format&fit=crop" alt="Garlic pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Garlic <span class="item-tag">Veg</span></div><div class="menu-card-desc">Garlic base, mozzarella cheese, oregano. Plus a can of drink.</div><div class="menu-card-price">$9.99</div></div></div>
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=500&q=70&auto=format&fit=crop" alt="Vegetarian pizza" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Vegetarian <span class="item-tag">Veg</span></div><div class="menu-card-desc">Tomato sauce, mozzarella cheese, mushrooms, capsicum, onions, olives, pineapple. Plus a can of drink.</div><div class="menu-card-price">$9.99</div></div></div>
    </div>
  </div>

  <!-- PASTAS -->
  <div id="tab-pasta" class="menu-section">
    <div class="sec-head"><h2>Pastas</h2><div class="price-pills"><span>Spaghetti · Fettuccine · Ravioli</span><span>Small $13</span><span>Large $16</span></div></div>
    <div class="sec-divider"></div>
    <div class="menu-grid">
  ...
  <div id="tab-mains" class="menu-section">
    ...
    <div class="menu-grid">
      ...
      <div class="menu-card"><img class="menu-card-img" src="https://images.unsplash.com/photo-1632778149955-e80f8ceca2e8?w=500&q=70&auto=format&fit=crop" alt="Chicken Parmigiana" loading="lazy"><div class="menu-card-body"><div class="menu-card-name">Chicken Parmigiana</div><div class="menu-card-desc">Chicken breast, homemade Napoli sauce and mozzarella cheese, served with salad and chips</div><div class="menu-card-price">$24</div></div></div>
